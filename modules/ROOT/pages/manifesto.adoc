...
* Single source of truth: Docs live in Antora; search is backed by Typesense; policies live in n00menon and are mirrored into dependents.
...
* xref:n00tropic-cerebrum:ROOT:submodules.adoc[Submodule playbook]
* xref:n00tropic-cerebrum:ROOT:search/typesense.adoc[Typesense runbook]
